...
public abstract class Lexeme {
    ...
    protected abstract void makeOperation(Stack<NumberLexeme> results) throws ParsingException, Exception;

    public void addLexeme(Stack<NumberLexeme> results, Stack<Lexeme> operations) throws ParsingException, Exception {
        try {
