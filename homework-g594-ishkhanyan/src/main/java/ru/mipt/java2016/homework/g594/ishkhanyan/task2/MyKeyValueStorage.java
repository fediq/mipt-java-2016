...
public class MyKeyValueStorage<Key, Value> implements KeyValueStorage<Key, Value> {
    ...
    public MyKeyValueStorage(String path, MySerialization keySerializator_, MySerialization valueSerializator_) throws Exception {
        keyType = "StudentKey";
        valueType = "Student";
        pathDirectory = path;
        File file = new File(pathDirectory);
        ...
        keySerializator = keySerializator_;
        valueSerializator = valueSerializator_;
