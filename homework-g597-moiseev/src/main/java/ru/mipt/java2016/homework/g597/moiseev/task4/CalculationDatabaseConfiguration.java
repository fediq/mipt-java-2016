...
public class CalculationDatabaseConfiguration {
    ...
    public DataSource billingDataSource(
            ...
            @Value("${ru.mipt.java2016.homework.g597.moiseev.task4.username:}") String username,
            @Value("${ru.mipt.java2016.homework.g597.moiseev.task4.password:}") String password
    ) {
