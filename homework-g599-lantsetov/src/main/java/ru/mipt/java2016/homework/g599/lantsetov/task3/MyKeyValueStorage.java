...
public class MyKeyValueStorage<K, V> implements KeyValueStorage<K, V> {
    ...
    private final MySerializer<K> keySerializer;
    private final MySerializer<V> valueSerializer;
    ...
    public MyKeyValueStorage(String path, MySerializer<K> keySerializerArg,
                             MySerializer<V> valueSerializerArg) throws IOException {
