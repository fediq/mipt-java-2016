...
public abstract class AbstractSingleFileStorageTest {
    ...
    protected abstract KeyValueStorage<String, String> buildStringsStorage(String path) throws Exception;

    protected abstract KeyValueStorage<Integer, Double> buildI2DStorage(String path) throws Exception;

    protected abstract KeyValueStorage<StudentKey, Student> buildStudentsStorage(String path) throws Exception;
